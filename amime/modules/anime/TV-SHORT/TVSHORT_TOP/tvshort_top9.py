...
@Amime.on_callback_query(filters.regex(r"^tvshort_top9 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tvshort_top9 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "tvshort_top8 anime 1"), (lang.Next, "tvshort_top10 anime 1")])
