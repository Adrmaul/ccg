...
@Amime.on_callback_query(filters.regex(r"^tvshort_trending9 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tvshort_trending9 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "tvshort_trending8 anime 1"), (lang.Next, "tvshort_trending10 anime 1")])
