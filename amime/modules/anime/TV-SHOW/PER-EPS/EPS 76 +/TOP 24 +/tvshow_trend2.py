...
@Amime.on_callback_query(filters.regex(r"^tvshow_76plus_top2 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tvshow_76plus_top2 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "tvshow_76plus_top1 anime 1"), (lang.Next, "tvshow_76plus_top3 anime 1")])
