...
@Amime.on_callback_query(filters.regex(r"^tvshow_24plus_top8 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tvshow_24plus_top8 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "tvshow_24plus_top7 anime 1"), (lang.Next, "tvshow_24plus_top9 anime 1")])
