...
@Amime.on_callback_query(filters.regex(r"^tvshow_51plus_top1 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tvshow_51plus_top1 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "tvshow_51plus_top anime 1"), (lang.Next, "tvshow_51plus_top2 anime 1")])
