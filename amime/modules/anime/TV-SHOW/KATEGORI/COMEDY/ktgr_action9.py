...
@Amime.on_callback_query(filters.regex(r"^tv_comedy9 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tv_comedy9 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "tv_comedy8 anime 1"), (lang.Next, "tv_comedy10 anime 1")])
