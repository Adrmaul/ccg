...
@Amime.on_callback_query(filters.regex(r"^tv_romance2 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tv_romance2 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "tv_romance1 anime 1"), (lang.Next, "tv_romance3 anime 1")])
