...
@Amime.on_callback_query(filters.regex(r"^tv_ecchi9 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tv_ecchi9 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "tv_ecchi8 anime 1"), (lang.Next, "tv_ecchi10 anime 1")])
