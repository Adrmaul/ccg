...
@Amime.on_callback_query(filters.regex(r"^tv_mahousj4 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tv_mahousj4 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "tv_mahousj3 anime 1"), (lang.Next, "tv_mahousj5 anime 1")])
