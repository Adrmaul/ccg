...
@Amime.on_callback_query(filters.regex(r"^tv_ongoing_ecchi anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
            ...
            json=dict(
                ...
                query($page: Int, $perPage: Int) {
                    Page(page: $page, perPage: $perPage) {
                        media(type: ANIME, format: TV, sort: TRENDING_DESC, status: RELEASING, genre: "ecchi") {
                            id
                            title {
                                romaji
                                english
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tv_ongoing_ecchi anime {pg}",
            )
