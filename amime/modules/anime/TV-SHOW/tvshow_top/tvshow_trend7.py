...
@Amime.on_callback_query(filters.regex(r"^tvshow_trending7 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"tvshow_trending7 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "tvshow_trending6 anime 1"), (lang.Next, "tvshow_trending8 anime 1")])
