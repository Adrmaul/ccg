...
@Amime.on_callback_query(filters.regex(r"^fall_2021-1 anime (?P<page>\d+)"))
    ...
    async with httpx.AsyncClient(http2=True) as client:
            ...
            json=dict(
                ...
                query($page: Int, $perPage: Int) {
                    Page(page: 2, perPage: $perPage) {
                        media(type: ANIME, format: TV, sort: TRENDING_DESC, year: 2021, season: FALL) {
                            id
                            title {
                                romaji
                                english
        ...
        if data["data"]:
            ...
            layout = Pagination(
                ...
                page_data=lambda pg: f"fall_2021-1 anime {pg}",
            )
            ...
            if len(lines) > 0:
                keyboard += lines
    keyboard.append([(lang.Prev, "fall_2021 anime 1"), (lang.Next, "fall_2021-2 anime 1")])
